...
export const ja: Translations = {
  ...
  features: {
    ...
    granularityTag: '粒度',
    moreLabel: 'さらに：',
    moreCapabilities: ['9言語出力', '思考が見える', '出典までたどれる', '自分のタグで整理', '矛盾を検出', '重複を統合', 'ネットワーク揺らぎも自動回復', '処理済みはスキップ'],
  },
  install: {
    label: 'はじめに',
    title: '数分で準備完了',
  ...
  providers: {
    ...
    privacyTitle: 'プライバシーが最優先',
    privacyDesc: 'バックエンドなし。追跡なし。保存なし。ノートはあなたの選んだAIだけに届く——ローカルモデルなら完全に本機内で完結。',
    affordableTitle: 'ほぼ無料',
    affordableDesc: 'インジェスト1回で$0.05–$0.50。コスト重視のモデルを選べば、費用はほとんど気にならない。',
    localBadge: 'ローカル',
  },
  trust: {
    label: '信頼',
    title: '任せられる知識。',
    subtitle: '一年分の思考をAIに預けても、安心できるプラグイン。',
    items: [
      {
        title: '答えはすべてたどれる',
        desc: 'すべての回答があなたのノートへ直接リンクする。捏造なし——あなたが書いた内容に、根拠つきで。',
        icon: 'quote',
      },
      {
        title: '仕上げた文章は守られる',
        desc: 'ページを reviewed としてマークすれば、AIは二度と書き換えない。言葉はあなたのもの——追記するだけで、上書きしない。',
        icon: 'lock',
      },
      {
        title: '矛盾は見える化',
        desc: '二つのソースが食い違うとき、AIはそれを静かに隠さず、衝突として表示する。真実を決めるのはあなた。',
        icon: 'git-compare',
      },
    ],
  },
