...
export const ja: Translations = {
  ...
  comparison: {
    ...
    afterLabel: 'After',
    items: [
      { category: '保存', before: '記事を保存。場所を忘れる。あとで検索。何も出ない。', after: 'Vault からノートを選ぶだけ。アイデアが見つかり、ページが作られ、要約も準備完了。数秒で。' },
  ...
  features: {
    ...
    organizeTitle: '自動で進む',
    organizeDesc: 'Vault からノートを選ぶ —— Cmd+P → Ingest。AIが読み、抽出し、構築。フォルダもタグも不要。作業も不要。',
    organizeTag: '手間なし',
