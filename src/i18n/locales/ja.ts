...
export const ja: Translations = {
  ...
  features: {
    ...
    historyTag: '操作履歴',
    pdfIngestTitle: 'あらゆる文書がソースに',
    pdfIngestDesc: 'PDF・画像・Office ファイルを vault に入れれば、ノートと同じ Wiki グラフに合流します。',
    pdfIngestTag: '文書取り込み',
    moreLabel: 'さらに：',
    moreCapabilities: ['11言語出力', '思考が見える', '矛盾を検出', '重複を統合', 'ネットワーク揺らぎも自動回復', '処理済みはスキップ', 'ネイティブ CLI', '巨大な vault でも快適'],
  },
  install: {
    label: 'はじめに',
    title: '数分で準備完了',
  ...
  faq: {
    ...
    items: [
      ...
      { q: '必要事項と費用は？', a: 'デスクトップ版 Obsidian の最新安定版と、LLM プロバイダーの API キー。長コンテキストモデルが最適。1 回の取り込みで LLM 側に $0.05〜$0.50——プラグイン自体は無料でオープンソース。Ollama / LM Studio のローカルモデルはキー不要。' },
