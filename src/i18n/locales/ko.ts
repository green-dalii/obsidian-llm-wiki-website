...
export const ko: Translations = {
  ...
  features: {
    ...
    granularityTag: '세분화',
    moreLabel: '그리고 더:',
    moreCapabilities: ['9개 언어 출력', '사고 과정을 본다', '출처까지 추적', '내 태그로 정리', '모순을 잡아냄', '중복을 병합', '네트워크 흔들림도 자동 복구', '처리한 건 건너뜀'],
  },
  install: {
    label: '시작하기',
    title: '몇 분이면 준비 완료',
  ...
  providers: {
    ...
    affordableTitle: '거의 무료',
    affordableDesc: '수집 한 번에 $0.05–$0.50. 가성비 좋은 모델을 고르면 비용은 거의 느껴지지 않습니다.',
    localBadge: '로컬',
  },
  trust: {
    label: '신뢰',
    title: '맡길 수 있는 지식.',
    subtitle: '한 해 동안의 사고를 AI에 맡겨도, 안심할 수 있는 플러그인.',
    items: [
      {
        title: '모든 답에 출처가 있다',
        desc: '모든 응답이 당신의 노트로 직접 연결됩니다. 없는 사실을 만들지 않음 — 당신이 쓴 내용에, 영수증까지.',
        icon: 'quote',
      },
      {
        title: '확정한 문장은 지켜진다',
        desc: '페이지를 reviewed 로 표시하면 AI는 다시 쓰지 않습니다. 당신의 말은 당신 것 — 덧붙이기만 하고 덮어쓰지 않습니다.',
        icon: 'lock',
      },
      {
        title: '모순은 드러난다',
        desc: '두 출처가 서로 다를 때, AI는 조용히 덮지 않고 충돌로 표시합니다. 진위를 결정하는 건 당신.',
        icon: 'git-compare',
      },
    ],
  },
