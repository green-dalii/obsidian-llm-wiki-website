...
export const ko: Translations = {
  ...
  features: {
    ...
    historyTag: '활동 기록',
    pdfIngestTitle: '모든 문서가 소스가 됩니다',
    pdfIngestDesc: 'PDF, 이미지, Office 파일—vault에 넣으면 노트와 같은 Wiki 그래프에 합류합니다.',
    pdfIngestTag: '문서 수집',
    moreLabel: '그리고 더:',
    moreCapabilities: ['11개 언어 출력', '사고 과정을 본다', '모순을 잡아냄', '중복을 병합', '네트워크 흔들림도 자동 복구', '처리한 건 건너뜀', '네이티브 CLI', '거대한 vault 도 부드럽게'],
  },
  install: {
    label: '시작하기',
    title: '몇 분이면 준비 완료',
  ...
  faq: {
    ...
    items: [
      ...
      { q: '뭐가 필요하고 비용은 얼마인가요?', a: '데스크톱 Obsidian 최신 안정판과 LLM 공급자 API 키. 긴 컨텍스트 모델이 최고. 한 번 수집에 LLM 측 $0.05–$0.50 — 플러그인 자체는 무료 오픈소스. Ollama / LM Studio 로컬 모델은 키 불필요.' },
