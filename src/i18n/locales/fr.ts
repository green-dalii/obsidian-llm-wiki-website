...
export const fr: Translations = {
  nav: { howItWorks: "Comment ça marche", comparison: "Pourquoi c'est important", features: "Fonctionnalités", ecosystem: "Écosystème", providers: 'Votre IA', install: "Installation", download: "Ajouter à Obsidian", faq: "FAQ", blog: "Blog", home: "Accueil", trust: "Confiance" },
  ...
  features: { label: "Fonctionnalités", title: "Ce qui change", subtitle: "Pas des fonctionnalités. Une nouvelle relation avec tout ce que vous lisez.", organizeTitle: "Ça se fait tout seul", organizeDesc: "Déposez-le dans sources/. L'IA lit, extrait, construit. Pas de dossiers. Pas de tags. Aucun effort.", organizeTag: "Zéro effort", bidirectionalTitle: "Des liens vivants", bidirectionalDesc: "Chaque page rejoint votre graphe Obsidian. Ouvrez la Vue du graphe — et regardez votre savoir grandir.", bidirectionalTag: "Connecté", conversationalTitle: "Parlez simplement", conversationalDesc: "Demandez comme à un ami. Voyez-le raisonner, puis répondre avec des sources que vous pouvez ouvrir et vérifier.", conversationalTag: "Naturel", autoMaintenanceTitle: "Reste à jour", autoMaintenanceDesc: "Nouveaux fichiers ? Pris automatiquement. Contradictions ? Détectées. Santé ? Vérifiée. À votre rythme.", autoMaintenanceTag: "À votre rythme",
    ...
    moreLabel: "Et encore :",
    moreCapabilities: ['Production en 9 langues', 'Voyez-le raisonner', 'Citations traçables', 'Vos propres tags', 'Détecte les contradictions', 'Trouve les doublons', 'Se remet des erreurs', 'Saute ce qui est fait'],
  },
  ...
  providers: { label: "Votre IA, vos règles", title: "Votre IA. Vos règles.", subtitle: "Douze fournisseurs, cloud ou local. Changez quand vous voulez — vous n'êtes lié à rien.", openSourceTitle: "Open source", openSourceDesc: "Licence MIT. Code source complet sur GitHub. Forkez, étendez, appropriez-vous-le.", communityTitle: "Communauté", communityDesc: "GitHub Discussions pour les idées et l'entraide. Contributions bienvenues.", vendorTitle: "La vie privée d'abord", vendorDesc: "Pas de stockage. Pas de backend. Aucune collecte de données. Vos notes restent dans votre Obsidian — envoyées à votre LLM uniquement pendant l'ingestion ou la requête. Les modèles locaux gardent tout hors ligne.", obsidianTitle: "Obsidian pur", obsidianDesc: "Pas d'applications supplémentaires. Vit entièrement dans votre Obsidian.", cardLabel: "Votre LLM, votre choix", cardSubtitle: "Compatible avec tous les fournisseurs. Pas de dépendance.", contextNote: "Modèles long contexte (256K+) recommandés. Tout votre wiki en une seule requête, compréhension totale.", bestValue: "Meilleur rapport qualité-prix",
    ...
    affordableTitle: "Quasi gratuit",
    affordableDesc: "Une ingestion complète coûte 0,05–0,50 $. Choisissez un modèle économique et vous remarquez à peine le coût.",
    localBadge: "Local" },
  ...
  trust: {
    label: 'Confiance',
    title: 'Des connaissances dignes de confiance.',
    subtitle: 'Une IA à laquelle vous pouvez confier une année de réflexion.',
    items: [
      {
        title: 'Chaque réponse est traçable',
        desc: 'Chaque réponse renvoie directement à vos propres notes. Pas de faits inventés — seulement ce que vous avez écrit, avec la preuve.',
        icon: 'quote',
      },
      {
        title: 'Ce que vous finalisez reste',
        desc: 'Marquez une page comme reviewed et l\'IA ne la réécrira jamais. Vos mots vous appartiennent — elle n\'ajoute que, elle n\'écrase jamais.',
        icon: 'lock',
      },
      {
        title: 'Les contradictions apparaissent',
        desc: 'Quand deux sources divergent, l\'IA signale le conflit au lieu de l\'occulter. Vous décidez de la vérité.',
        icon: 'git-compare',
      },
    ],
  },
  faq: {
    ...
    items: [
      ...
      { q: 'Quels sont les prérequis ?', a: 'Obsidian v1.11.0+ (bureau: Windows, macOS, Linux) et une clé API LLM. Fournisseurs pris en charge: DeepSeek, Gemini, Claude, GPT, Kimi, GLM, MiniMax, OpenRouter ou tout endpoint personnalisé. Aucune clé requise pour les modèles locaux via Ollama ou LM Studio.' },
      ...
      { q: 'Puis-je fonctionner entièrement hors ligne ?', a: 'Oui. Installez <em>Ollama</em> ou <em>LM Studio</em>, récupérez un modèle, sélectionnez-le comme fournisseur — aucune clé requise, rien ne quitte votre machine. Le cloud est recommandé pour les ingestions lourdes (plus de contexte); les modèles locaux conviennent bien aux requêtes quotidiennes.' },
