...
export const es: Translations = {
  ...
  footer: { emailUser: 'hi', emailDomain: 'greenerai.top', emailLabel: 'Contacto:', github: 'GitHub', discussions: 'Feedback', releases: 'Versiones', obsidian: 'Obsidian', sponsorUs: 'Apóyanos' },
