...
export const pt: Translations = {
  ...
  footer: { emailUser: 'hi', emailDomain: 'greenerai.top', emailLabel: 'Contato:', github: 'GitHub', discussions: 'Feedback', releases: 'Versões', obsidian: 'Obsidian', sponsorUs: 'Apoie-nos' },
