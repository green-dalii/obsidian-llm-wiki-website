...
export const zh: Translations = {
  ...
  features: {
    ...
    historyTag: '操作历史',
    pdfIngestTitle: '文档就是源',
    pdfIngestDesc: 'PDF、图片、Office 文件——丢进 vault 即可。和笔记接入同一张 Wiki 图。',
    pdfIngestTag: '文档摄入',
    moreLabel: '更多能力：',
    moreCapabilities: ['11 语言输出', '看它如何思考', '发现矛盾', '识别重复', '网络抖动自动恢复', '跳过已处理', 'Agent 原生 CLI 接口', '海量笔记也流畅'],
  },
  install: {
    label: '快速开始',
    title: '三分钟就好',
  ...
  faq: {
    ...
    items: [
      ...
      { q: '需要什么？要花多少钱？', a: '桌面端 Obsidian 最新稳定版，以及一个 LLM 提供商 API 密钥。推荐长上下文模型。单次摄入成本通常 $0.05–$0.50——插件本身免费且开源。本地模型（Ollama / LM Studio）无需密钥。' },
