  ...
  comparison: {
    ...
    items: [
      ...
      },
      {
        ...
        after: 'A year builds a wiki. Every new question draws on everything you\'ve read. Your knowledge grows.',
      },
    ],
  },
  features: {
...
export const zh: Translations = {
  ...
  comparison: {
    ...
    items: [
      ...
      },
      {
        ...
        after: '一年积累成一部 Wiki。每个新问题，都能从你读过的全部内容中找到答案。知识在生长。',
      },
    ],
  },
  features: {
  ...
  providers: {
    ...
    obsidianDesc: '无需额外应用。一切只在你的 vault 里。',
