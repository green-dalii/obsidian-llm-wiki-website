...
export const en: Translations = {
  ...
  hero: {
    ...
    subtitle: 'Drop raw notes into Obsidian. An AI reads them, extracts key ideas, and builds a self-maintaining wiki with cross-references — knowledge that compounds with every source you add.',
  ...
  philosophy: {
    ...
    hook3: "What if your notes did not just sit in folders? What if an LLM built a living wiki — cross-referenced, self-maintained, growing richer with every article you add? Obsidian is the IDE; the LLM is the programmer; the wiki is the codebase.",
    hook4: "A year from now, asking about a topic you researched last month will not return raw text. It will return a curated, cited synthesis — the accumulated understanding of everything you have read. Your knowledge base compounds like interest.",
  },
  wikiDemo: {
    label: 'How It Works',
    ...
    step2Desc: 'The LLM reads the full context (not chunks), identifies people, organizations, and key themes.',
    ...
    step5Desc: 'Ask in natural language. The LLM reads your wiki pages, synthesizes cited answers, and can save them back as new pages.',
    next: 'Next',
    prev: 'Previous',
    restart: 'Restart',
    ...
    items: [
      {
        ...
        after: 'Drop it in sources/. The AI reads it, extracts key ideas, updates 10–15 related wiki pages, and files the summary. Done in seconds.',
      },
      {
      ...
      },
      {
        ...
        after: 'Ask the same question. The AI reads relevant pages, synthesizes a cited answer with [[wiki-links]] as breadcrumbs. You read the answer.',
      },
      {
  ...
  architecture: {
    ...
    subtitle: "Karpathy's design: raw sources are immutable. The LLM owns the wiki. You evolve the structure over time.",
    sourcesPath: 'sources/',
    sourcesTitle: 'Raw Sources',
    sourcesDesc: 'Your curated collection — articles, papers, book notes, clippings. Immutable. The LLM reads but never modifies. This is your source of truth.',
    ...
    wikiPath: 'wiki/',
    wikiTitle: 'The Wiki',
    wikiDesc: 'Auto-generated markdown files — summaries, entity pages, concept pages, an index, a log. The LLM owns this layer. You read it; the LLM writes it.',
  },
  features: {
    label: 'Features',
    ...
    organizeDesc: 'Drop articles, papers, or notes into sources/. The AI reads them in full context, extracts entities and concepts, and builds structured wiki pages — no manual tagging, no folders to manage.',
    ...
    conversationalDesc: 'Ask questions about your knowledge in natural language. The AI reads your wiki pages (not the internet), synthesizes cited answers with [[wiki-links]], and can save responses back as new wiki pages.',
...
export const zh: Translations = {
  ...
  hero: {
    ...
    title1: '你的笔记。',
    title2: '一部活的 Wiki。',
    subtitle: '把原始笔记放进 Obsidian。AI 自动阅读、提取关键概念，构建一部自带交叉引用的自维护 Wiki —— 每添加一个来源，知识就更丰厚。',
    ctaInstall: '获取插件',
    ctaRead: '阅读原始概念',
    legendSources: 'sources/',
    legendEntities: 'entities/',
  ...
  philosophy: {
    ...
    hook3: '如果你的笔记不只是躺在文件夹里呢？如果 LLM 构建了一部活的 Wiki——交叉引用、自动维护、每添加一篇文章就更丰富呢？Obsidian 是 IDE；LLM 是程序员；Wiki 是代码库。',
    hook4: '一年后，询问你上个月研究过的话题，返回的不是原始文本。而是一部策划过的、带引用的综合——你读过的所有内容的累积理解。你的知识库像利息一样复利增长。',
  },
  wikiDemo: {
    label: '工作原理',
    ...
    step2Desc: 'LLM 读取全文上下文（不是片段），识别人物、组织和关键主题。',
    ...
    step5Desc: '用自然语言提问。LLM 读取你的 Wiki 页面，综合带引用的答案，还可以把回答存为新页面。',
    next: '下一步',
    prev: '上一步',
    restart: '重新开始',
    sourceNote: '源笔记',
    ...
    items: [
      {
        ...
        after: '把文章放入 sources/。AI 阅读、提取关键概念，更新 10-15 个相关 Wiki 页面，并归档摘要。几秒钟完成。',
      },
      {
        category: '交叉引用',
      ...
      },
      {
        ...
        after: '问同样的问题。AI 读取相关 Wiki 页面，综合带 [[wiki-links]] 引用的答案。你阅读答案，而非构建它。',
      },
      {
        category: '知识的长期增长',
  ...
  architecture: {
    label: '架构',
    title: '三层分离。一个目标。',
    subtitle: 'Karpathy 的设计：原始笔记不可变。LLM 全权拥有 Wiki。你随时间演化结构。',
    sourcesPath: 'sources/',
    sourcesTitle: '原始笔记',
    sourcesDesc: '你精心策展的集合——文章、论文、读书笔记、摘录。不可变。LLM 只读不写。这是你的真相来源。',
    enginePath: 'AI 引擎',
    engineTitle: 'LLM + 模式层',
  ...
  features: {
    ...
    organizeTitle: '自动组织',
    organizeDesc: '把文章、论文或笔记扔进 sources/。AI 读取全文上下文，提取实体和概念，构建结构化 Wiki 页面——无需手动打标签，无需管理文件夹。',
    organizeTag: '零配置',
    ...
    conversationalDesc: '用自然语言向你的知识提问。AI 读取你的 Wiki 页面（而非互联网），综合带 [[wiki-links]] 引用的答案，还可以把回答存为新的 Wiki 页面。',
