...
export const en: Translations = {
  ...
  hero: {
    ...
    subtitle: 'Write in Obsidian. Every note finds its place in a network that grows with you.',
  ...
  wikiDemo: {
    ...
    step2Desc: 'People, places, themes. AI understands the full story and brings the important parts forward.',
    ...
    step5Title: 'Just ask',
    step5Desc: 'Ask naturally. Your wiki answers with sources you can trust, ready to become new pages.',
    next: 'Next',
    prev: 'Previous',
    restart: 'Restart',
    sourceNote: 'Source',
  ...
  comparison: {
    ...
    title: 'Lose it, or grow it?',
    subtitle: 'What changes when your notes start working for you.',
    beforeLabel: 'Before',
    afterLabel: 'After',
    items: [
      {
      ...
      },
      {
        ...
        after: 'Links stay alive. When something new contradicts something old, every page knows.',
      },
      {
        category: 'Growing',
        before: 'A year of notes. Just files. Every project starts over. Same reading. Same conclusions.',
        after: 'A year builds a wiki. New questions pull from everything you\'ve read. Your knowledge grows.',
      },
    ],
  },
  features: {
    ...
    bidirectionalDesc: 'Every page joins your Obsidian graph. Open Graph View — watch your knowledge breathe and grow.',
    ...
    autoMaintenanceTitle: 'It takes care',
    autoMaintenanceDesc: 'New files? Auto-ingested. Contradictions? Found. Health? Checked. All when you want it.',
  ...
  providers: {
    ...
    subtitle: 'MIT licensed. Community driven. No strings attached. Completely yours.',
    ...
    vendorTitle: 'Your choice',
    vendorDesc: 'Your LLM, your call. Cloud or local, switch anytime.',
  ...
  ecosystem: {
    ...
    items: [
      ...
      },
      {
        ...
        amplified: 'Ask: "Summarize my research for 10 minutes." Wiki builds slides from what you know.',
      },
      {
        name: 'Canvas',
        standalone: 'Visual canvas',
        amplified: 'AI builds concept maps, timelines, decision trees from your knowledge. No blank canvas.',
      },
    ],
...
export const zh: Translations = {
  ...
  hero: {
    ...
    title1: '你的笔记。',
    title2: '一部活的 Wiki。',
    subtitle: '在 Obsidian 随手记录。每一页都会自然融入生长的知识网络。',
    ctaInstall: '获取插件',
  ...
  wikiDemo: {
    ...
    subtitle: '一条笔记，万千连接。',
    step1Title: '随手放入',
    step1Desc: '文章、论文、灵感。放进 sources/，插件会读懂每一个字。',
    step2Title: '看见重点',
    step2Desc: '人物、地点、主题。AI 读懂完整脉络，把重要信息带到你面前。',
    step3Title: '页面自成',
    step3Desc: '每个概念都有自己的空间。内容、含义、连接——全都为你准备好。',
    step4Title: '看见生长',
    step4Desc: '页面彼此相连。打开图谱视图，看知识网络慢慢成形。',
    step5Title: '开口即问',
    step5Desc: '像问朋友一样自然提问。你的 Wiki 带着可靠出处回答，还能存成新页面。',
    next: '下一步',
    prev: '上一步',
    restart: '重播',
    sourceNote: '来源',
  ...
  comparison: {
    ...
    items: [
      ...
      },
      {
        ...
        after: '链接始终鲜活。新信息与旧笔记矛盾时，每个页面都知晓。',
      },
      {
        category: '生长',
        before: '记了一年，还是一堆文件。每个项目从零开始。反复阅读，原地打转。',
        after: '一年积累成一座 Wiki。新问题能调用你读过的全部内容。知识在生长。',
      },
    ],
  },
  features: {
    label: '功能',
    title: '真正的改变',
    subtitle: '不是功能列表。是你与所读之物关系的蜕变。',
    organizeTitle: '水到渠成',
    organizeDesc: '放进 sources/，AI 阅读、提炼、构建。无需文件夹，无需标签，无需动手。',
    organizeTag: ' effortless',
    bidirectionalTitle: '活的链接',
    bidirectionalDesc: '每一页都融入 Obsidian 图谱。打开视图——看知识网络呼吸生长。',
    bidirectionalTag: '已连接',
    conversationalTitle: '开口即聊',
    conversationalDesc: '像和朋友聊天一样提问。你的 Wiki 带着可信赖的出处回答你。',
    conversationalTag: '自然',
    autoMaintenanceTitle: '自主照料',
  ...
  ecosystem: {
    ...
    items: [
      ...
      },
      {
        name: 'Marp',
        standalone: '制作幻灯片',
        amplified: '一句请求："为 10 分钟演讲总结我的研究。" Wiki 从你所知构建幻灯片。',
      },
      {
        name: 'Canvas',
        standalone: '可视化画布',
        amplified: 'AI 从知识图谱构建概念图、时间线、决策树。再无空白画布。',
      },
    ],
