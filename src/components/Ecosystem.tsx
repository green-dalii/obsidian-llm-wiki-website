      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {t.ecosystem.items.map((item, i) => {
            const Icon = ICONS[i];
            return (
              <div key={i} className="eco-card group rounded-lg border border-obsidian-border bg-obsidian-card/40 p-5 hover:border-obsidian-purple/25 hover:bg-white/[0.02] transition-all duration-250">
