            ...
            return (
              <CardWrapper key={p.key}>
                <div className={`pillar-card group p-4 rounded-xl border transition-all duration-250 h-full ${
                  p.link
                    ? 'border-obsidian-border bg-obsidian-surface/30 hover:border-obsidian-purple/30 hover:bg-obsidian-purple/5 cursor-pointer'
                    : 'border-obsidian-border bg-obsidian-surface/30'
                }`}>
          ...
          {PROVIDERS.map((p) => (
            <div key={p.name} className={`provider-card group p-3.5 rounded-lg border transition-all duration-200 ${
              p.badge === 'bestValue'
                ...
                : 'border-obsidian-border bg-obsidian-surface/40 hover:border-obsidian-purple/30 hover:bg-obsidian-purple/5'
            }`}>
