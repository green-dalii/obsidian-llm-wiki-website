    ...
    <section ref={sectionRef} id="features" className="relative w-full py-28 sm:py-36">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {features.map((f, i) => (
            <div key={f.title} className="feature-card group rounded-xl border border-obsidian-border bg-obsidian-card/60 overflow-hidden hover:shadow-[0_0_40px_rgba(139,92,246,0.08)] transition-all duration-300">
